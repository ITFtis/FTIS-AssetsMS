...
namespace DouImp.Controllers
{
    ...
    public class UserController : Dou.Controllers.UserBaseControll<User, Role>
    {
        ...
        internal static FtisHelperAsset.DB.Model.F22cmmEmpData CurrentFtisEmployee
        {
            get { return DouUnobtrusiveSession.Session["CurrentFtisUser"] as FtisHelperAsset.DB.Model.F22cmmEmpData; }
        }
